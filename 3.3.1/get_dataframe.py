...
def get_file():
    ...
    os.chdir("F:\\01_个人资料\\LatexThesis4SYSU\\hmm0602\\result\\3.3.1")
...
def process_df(df):
    ...
    #每一种算法在不同请求大小时的平均时间。16KB，64KB，256KB，1MB，1MB共5组
    aioli=mean_list[0:5]
    mlf=mean_list[5:10]
    ...
    final_df.index=["64KB","256KB","1MB","4MB","16MB"] #此时没有index，所以可以直接用index赋值的方式添加
    print(final_df)
