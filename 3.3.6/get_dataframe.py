...
def get_file():
    ...
    os.chdir("F:\\01_个人资料\\LatexThesis4SYSU\\hmm0602\\result\\3.3.6")
...
def process_df(df):
    ...
    #twins服务器窗口大小变化时各算法的性能，分别是"50","100","150","200","250"us
    aioli=mean_list[0:5]
    mlf=mean_list[5:10]
    ...
    final_df.index=["1","5","25","125","625"] #此时没有index，所以可以直接用index赋值的方式添加
    print(final_df)
