                        ...
                        for requests_byte in requests_bytes:
                            for inter_time in inter_times:
                                for process_time in process_times:
                                    str=f"yhrun -n 10 {base_dir}/{algo}.out {thread} {file} {per_request} {identifier} {sequential_percent} {requests_byte} {inter_time} {process_time} {seed} >>{base_dir}/result/4.3.5/{algo}.result\n"
