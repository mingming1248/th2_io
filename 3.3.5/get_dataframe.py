...
def get_file():
    ...
    os.chdir("F:\\01_个人资料\\LatexThesis4SYSU\\hmm0602\\result\\3.3.5")
...
def process_df(df):
    ...
    #每一种算法在不同爆发性时的平均时间。"100us","1ms","10ms","100ms","1s"共5组
    aioli=mean_list[0:5]
    mlf=mean_list[5:10]
    ...
    final_df.index=["100ns","1us","10us","100us","1ms"] #此时没有index，所以可以直接用index赋值的方式添加
    print(final_df)
